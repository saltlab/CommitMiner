...
public class TypeChangeLatticeElement {
	...
	public TypeChangeLatticeElement() {
		this.element = SpecialType.BOTTOM;
		this.change = Change.BOTTOM;
	}

	public TypeChangeLatticeElement(SpecialType element, Change change) {
	 ...
	 */
	public TypeChangeLatticeElement transfer(CFGEdge edge) {
		return null;
	}
	 ...
	 */
	public TypeChangeLatticeElement transfer(CFGNode node) {
		return null;
	}
	 ...
	 */
	public static TypeChangeLatticeElement join(TypeChangeLatticeElement left,
										  TypeChangeLatticeElement right) {

		SpecialType type = lubElement(left.element, right.element);
		Change change = lubChange(left.change, right.change);

		return new TypeChangeLatticeElement(type, change);
	 ...
	 */
	public TypeChangeLatticeElement copy() {
		return new TypeChangeLatticeElement(this.element, this.change);
	}

	@Override
	public boolean equals(Object o) {
		if(o instanceof TypeChangeLatticeElement) {
			TypeChangeLatticeElement tle = (TypeChangeLatticeElement) o;
