 ...
 *
 */
public class STHLatticeElement extends AbstractLatticeElement{
	...
	public STHLatticeElement(Map<String, List<SpecialType>> specialTypes, Map<String, List<SpecialType>> nonSpecialTypes, Map<String, SpecialType> assignments, Map<Long, Integer> visitedEdges) {
		super(visitedEdges);
	 ...
	 */
	public static STHLatticeElement copy(STHLatticeElement le) {
		...
		return new STHLatticeElement(specialTypes,
											 nonSpecialTypes,
