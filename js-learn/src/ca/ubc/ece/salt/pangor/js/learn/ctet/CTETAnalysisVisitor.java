 ...
 */
public class CTETAnalysisVisitor implements NodeVisitor {
	...
	public static void getLearningFacts(Map<IPredicate, IRelation> facts,
		...
		CTETAnalysisVisitor visitor = new CTETAnalysisVisitor(facts, scfc,
	...
	private CTETAnalysisVisitor(Map<IPredicate, IRelation> facts,
