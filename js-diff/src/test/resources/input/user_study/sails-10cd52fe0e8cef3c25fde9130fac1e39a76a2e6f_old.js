module.exports = function(sails) {
	...
	function Router(options) {
		...
		Router.prototype.load = function(cb) {
			...
			// (all hooks have declared they are ready)
			// This guarantees that these routes will be bound last
			sails.on('ready', function () {

				// Bind configured 404 behavior
				sails.router.bind('/*',sails.config[404]);
			});
        ...
        if (typeof sails.config[404] === 'function') {
          return sails.config[404](err, req, res) 
        }
